## 1. Implementation
- [ ] 1.1 TS SDK: add `@hivellm/thunder`, rewire the transport onto the Thunder client under the Nexus profile; delete `src/transports/codec.ts`, `rpc.ts`, `types.ts` (PKG-040); command map, endpoint factory, and public API unchanged (PKG-021, NFR-04)
