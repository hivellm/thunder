## 1. Implementation
- [ ] 1.1 TS SDK: rewire onto `@hivellm/thunder` under the Synap profile; delete the transport internals (PKG-040); command catalog + public API unchanged (PKG-021, NFR-04)
