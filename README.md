...
![Status](https://img.shields.io/badge/version-0.2.2-success.svg)
...
All four registry packages are at **0.2.2**, with Go alongside them as a fifth full client (tagged `v0.2.2` in [hivellm/thunder-go](https://github.com/hivellm/thunder-go)) and PHP as a sixth ([hivellm/thunder-php](https://github.com/hivellm/thunder-php), not yet published to Packagist). Wire v1 is frozen; the API is not — 0.x may still break.
