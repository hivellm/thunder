...
pub mod bench {
    ...
    pub type CallParams<> = ::capnp::capability::Params<crate::bench_capnp::bench::call_params::Owned>;
    pub type CallResults<> = ::capnp::capability::Results<crate::bench_capnp::bench::call_results::Owned>;
    ...
    impl  Client {
        pub fn call_request(&self) -> ::capnp::capability::Request<crate::bench_capnp::bench::call_params::Owned,crate::bench_capnp::bench::call_results::Owned> {
            self.client.new_call(_private::TYPE_ID, 0, ::core::option::Option::None)
        }
    }
    pub trait Server<> : 'static  {
        fn call(self: ::capnp::capability::Rc<Self>, _: CallParams<>, _: CallResults<>) -> impl ::core::future::Future<Output = Result<(), ::capnp::Error>> + 'static { ::core::future::ready(Err(::capnp::Error::unimplemented("method bench::Server::call not implemented".to_string()))) }
    }
    ...
    pub(crate) mod _private {
        pub(crate) const TYPE_ID: u64 = 0xe4d7_65bf_f843_6db3;
    }
    ...
    pub mod call_params {
        ...
        mod _private {
            pub(crate) static ENCODED_NODE: [::capnp::Word; 48] = [
                ...
                ::capnp::word(141, 195, 70, 212, 148, 222, 199, 247),
                ...
                ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
                ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
                ::capnp::word(98, 101, 110, 99, 104, 46, 99, 97),
                ::capnp::word(112, 110, 112, 58, 66, 101, 110, 99),
                ::capnp::word(104, 46, 99, 97, 108, 108, 36, 80),
            ...
            pub(crate) const TYPE_ID: u64 = 0xf7c7_de94_d446_c38d;
        }
    }
    ...
    pub mod call_results {
        ...
        mod _private {
            pub(crate) static ENCODED_NODE: [::capnp::Word; 33] = [
                ::capnp::word(0, 0, 0, 0, 6, 0, 6, 0),
                ::capnp::word(200, 203, 192, 85, 10, 11, 61, 192),
                ::capnp::word(18, 0, 0, 0, 1, 0, 0, 0),
                ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
                ...
                ::capnp::word(98, 101, 110, 99, 104, 46, 99, 97),
                ::capnp::word(112, 110, 112, 58, 66, 101, 110, 99),
                ::capnp::word(104, 46, 99, 97, 108, 108, 36, 82),
            ...
            pub(crate) const TYPE_ID: u64 = 0xc03d_0b0a_55c0_cbc8;
        }
    }
}
